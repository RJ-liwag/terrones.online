...
<ul class="nav nav-pills nav-justified">
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="./room-cottage">Rooms</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="./room-cottage-c">Cottages</a>
    </li>
</ul>

<h3 class="d-flex justify-content-center">Rooms</h3>

<?php

if ($rooms_query->num_rows > 0) {
    do {
        ?>
        <div class="container w-100 mt-3 mx-auto">
            <div class="row">
                <div class="col mt-3 p-3">
                    <img src="admin/assets/rooms-cottages/<?php echo $row['room_img'] ?>" class="shadow-sm bg-body rounded"
                ...
                <div class="col mt-3 p-3">
                    ...
                    <p class="demo mb-0">
                        <label class="">₱
                            <span><strong><?php echo $row["price"] ?></strong></span></label><br>
                        <label class="text-primary fw-bold">Pax Capacity :
                            <span><strong><?php echo $row["max_capacity"] ?></strong></span></label>
                    </p>
                    <div class="d-flex justify-content-start mt-3">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            data-id="<?php echo $row['room_id']; ?>" data-name="<?php echo $row['room_name']; ?>"
                            data-price="<?php echo $row['price']; ?>" data-pax="<?php echo $row['max_capacity']; ?>">
                            Make a reservation
                        </button>
                    </div>
                </div>
        ...
        <?php
    }while ($row = $rooms_query->fetch_array());
} else {
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid" id="form_modal">
                            ...
                            <div class="page slide-page">
                                ...
                                <div class="field" style="margin-top: -20px; margin-bottom: 0;">
                                    <select id="tour_type" class="form-select form-select-sm"
                                        ...
                                        <option selected disabled>Reservation Type</option>
                                ...
                                <p id="pax_status"></p><br>
                                <p id="availability-status">checking room availability</p>
                                <div class="field">
                                    <button class="firstNext next bg-secondary" disabled>Next</button>
                                </div>
                            </div>
                            <div class="page">
                                <div class="title">
            ...
            if (checkIn && checkOut && tourType) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        } else if (response === 'Available' && maxPax >= rPaxInput) {
